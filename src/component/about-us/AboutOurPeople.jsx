import { ArrowRight, Facebook, Linkedin, Mail, Twitter, Star, Award, GraduationCap } from "lucide-react";
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="text-center space-y-4">
        <h2 className="text-4xl font-bold text-[#0A1A2F]">Meet Our Legal Team</h2>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Experienced professionals dedicated to providing exceptional legal services with expertise and compassion.
        </p>
      </div>
            ...
            <SwiperSlide key={index}>
              <div className="group relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 overflow-hidden h-full flex flex-col">
                ...
                <div className="relative overflow-hidden">
                  ...
                  {/* Hover Overlay */}
                  <div className="absolute inset-0 bg-[#0A1A2F] bg-opacity-90 opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-center p-6">
                    <div className="text-center text-white space-y-3">
                      <h3 className="text-xl font-bold">{member.name}</h3>
                      {member.service?.service_name && (
                        <p className="text-[#CBA054] font-semibold">{member.service.service_name}</p>
                      )}
                      <p className="text-sm text-gray-300">Click to view full profile</p>
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-6 flex-wrap">
            {[
              ...
              {
                icon: Twitter,
                href: `https://x.com/intent/tweet?url=${encodeURIComponent(window.location.href)}&text=Meet our exceptional legal team:`,
              ...
              {
                icon: Mail,
                href: `mailto:?subject=Meet Our Legal Team&body=Check out our exceptional legal professionals: ${encodeURIComponent(window.location.href)}`,
