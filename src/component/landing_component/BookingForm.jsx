...
import { Calendar, Clock, Send, RefreshCw, Shield } from "lucide-react";
...
const BookingForm = ({ servicesList = [], teamList = [] }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!timeRegex.test(formData.time)) {
      toast.error(
        "Please enter a valid time in HH:MM format (e.g., 14:30 or 09:00)"
      );
      return;
    }
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="text-sm text-[#0A1A2F] font-medium">
                          ...
                          within 24 hours to confirm your appointment schedule.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              {/* Right Side - SVG Animation (Keep your existing SVG) */}
              <div className="bg-gradient-to-br from-[#0A1A2F] to-[#1E354F] p-8 lg:p-12 flex items-center justify-center relative overflow-hidden">
                {/* Your existing SVG animation code remains the same */}
